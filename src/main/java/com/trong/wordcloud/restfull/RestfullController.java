package com.trong.wordcloud.restfull;


import java.util.Collections;
import java.util.List;

import com.trong.wordcloud.log.LogAop;
...
import com.trong.wordcloud.data.ConversationList;
import com.trong.wordcloud.data.TopANode;
import com.trong.wordcloud.data.UserConversationData;
import com.trong.wordcloud.data.UserInfo;
import com.trong.wordcloud.data.UserTag;
import com.trong.wordcloud.data.UserTopKData;
import com.trong.wordcloud.data.UsernameToId;
import com.trong.wordcloud.data.UsertagData;
...
public class RestfullController
{
    ...
    @LogAop(desc = "get_data_userid")
    @RequestMapping(value="/rest/userid/{userid}", method=RequestMethod.GET)
    public @ResponseBody
    UserInfo get_data_userid(@PathVariable String userid) {
